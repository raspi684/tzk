...
@section('content')
    <div id="welcome">
        ...
        <img src="{{asset('img/img2.jpg')}}" alt="food">
        <div class="panel">
        ...
        <img src="{{asset('img/img3.jpg')}}" alt="food">
        <div class="panel">
        ...
        <img src="{{asset('img/img1.jpg')}}" id="img3" alt="food">
        <div class="panel">
        ...
        <img src="{{asset('img/img7.jpg')}}"  id="img4" alt="food">
    </div>
